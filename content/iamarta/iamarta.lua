...
FishAndChips.Fish{
    ...
    calculate = function(self, card, context)
        ...
        elseif context.fac_fish_caught then
            if not context.blueprint and not context.retrigger_joker and context.perfect and FishAndChips.get_bait_inventory_item(G.GAME.fac_last_used_bait).amt > 1 then
