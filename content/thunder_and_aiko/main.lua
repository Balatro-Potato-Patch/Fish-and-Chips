...
FishAndChips.Fish({
	...
	attributes = { "xmult", "generation", "scaling", "usable", "playing_card", "enhancements", },
	ppu_coder = { "thunderedge" },
	ppu_artist = { "aikoyori" },
...
FishAndChips.Fish({
	...
	attributes = { "usable", "enhancements", "destroy_card", "position", },
	ppu_coder = { "thunderedge" },
	ppu_artist = { "aikoyori" },
...
FishAndChips.Fish({
	...
	attributes = { "economy", "lose_economy", "hands", },
	ppu_coder = { "thunderedge" },
	ppu_artist = { "aikoyori" },
	loc_vars = function(self, info_queue, card)
		return {
...
FishAndChips.Fish({
	...
	blueprint_compat = false,
	attributes = { "economy", "generation", "usable", "generation", "tarot" },
	ppu_coder = { "thunderedge" },
	ppu_artist = { "aikoyori" },
...
FishAndChips.Fish({
	...
	attributes = { "xmult", "destroy_card", "chance", "scaling", },
	ppu_coder = { "thunderedge" },
	ppu_artist = { "aikoyori" },
