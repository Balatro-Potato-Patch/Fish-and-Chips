...
FishAndChips.Fish {
    ...
    calculate = function(self, card, context)
        ...
        elseif not context.blueprint then
            ...
            elseif context.pre_discard and not card.ability.extra.enchant and (next(get_flush(context.full_hand)) or next(get_straight(context.full_hand, SMODS.four_fingers("straight"), SMODS.shortcut(), SMODS.wrap_around_straight()))) then
