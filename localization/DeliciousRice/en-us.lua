        ...
        fac_Fish = {
            fish_fac_delrice_fringills = {
                ...
                text = {
                    ...
                    "you defeat a {C:attention}Blind{}",
                    "on your first hand"
                },
                flavor = {
            ...
            fish_fac_delrice_spongebob = {
                ...
                text = {
                    ...
                    {
                        "{C:red,E:2}Self destructs{} if not",
                        "{C:attention}rehydrated{} at a fishing spot",
                        "with {C:blue}water{} after every round",
                        "{ppu:usable}"
                    }
                },
                flavor = {
            ...
            fish_fac_delrice_blender = {
                ...
                text = {
                    {
                        "Blends all fish into",
                        "a {C:attention}fish smoothie{}, which",
                        "absorbs all their effects",
                        "{ppu_bubble:1}"
                    },
                    {
            ...
            fish_fac_delrice_gambling = {
                ...
                text = {
                    {
                        "Gives {C:fac_sand_dollars,f:fac_sand_dollars}$#1#{} when a {C:attention}Treasure{} is",
                        "collected and increases reward by {C:fac_sand_dollars,f:fac_sand_dollars}$#2#{}"
                    },
                    {
