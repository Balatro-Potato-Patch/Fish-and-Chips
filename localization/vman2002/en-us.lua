...
return {
	misc = {
		dictionary = {
			...
			fac_vman2002_timothy3 = "What is a Balatro anyway?",
			fac_vman2002_timothy4 = "I can't find Gros Michel again?",
			fac_vman2002_timothy5 = "I can't move Ceremonial Dagger?",
			fac_vman2002_timothy6 = "Luchador didn't disable the Boss Blind?",
			fac_vman2002_timothy7 = "Seed Money? Sure! (what's Green Deck?)",
