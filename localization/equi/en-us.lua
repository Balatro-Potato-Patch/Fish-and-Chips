    ...
    descriptions = {
        fac_Fish = {
            ...
            fish_fac_antarctickrill = {
                ...
                text = {
                    "Create a random {C:blue}Common{C:attention} Joker{}",
                    "if hand is played with",
                    "at least {C:attention}#1# {C:fac_sand_dollars}Sand Dollars{}"
                },
                flavour = {
            ...
            fish_fac_gofish = {
                name = "Go Fish",
                text = {
                    "When Blind is selected, this fish",
                    "asks for a random {C:attention}rank{}. If your first",
                    "hand has {C:attention}only{} that rank, destroy all",
                    "played cards and gain {X:mult,C:white}X#3#{} Mult for each",
