return {
        ...
        fac_Fish = {
            ...
            fish_fac_perkoio = {
                ...
                flavor = {
                    ...
                    "unpredictable, likely due to centuries of",
                    "alcohol being poured into its home waters."
                }
            },
             fish_fac_yoray = {
                name = "Yoray Eel",
    ...
    misc = {
        quips = {
            ...
            CCitty_tip3 = {
                "Did you know? The legendary",
                "Canioctopus can be found in the volcano!",
            },
            CCitty_tip4 = {
                "Did you know? The legendary",
                "Yoray Eel can be found in the Styx!",
            },
            CCitty_tip5 = {
                "Did you know? The legendary",
                "Chicod can be found in the city!",
            },
            CCitty_welcomeback = {
