        ...
        fac_Fish = {
            ...
            fish_fac_aureallu_mult_mola = {
                ...
                text = {
                    ...
                    "each empty {C:attention}Bucket slot",
                    "{C:inactive}(Currently {C:mult}#2#{C:inactive} Mult)"
                },
                flavor = {
                    "Too red to fail"
            ...
            fish_fac_aureallu_gouramichel = {
                ...
                text = {
                    ...
                    "this {C:fac_fish}Fish{} {C:red,E:2}dips{}",
            ...
            fish_fac_aureallu_soldierfish = {
                ...
                text = {
                    ...
                    "{C:inactive,s:0.9}Costs {C:money,s:1.0}$#2#, {C:inactive,s:0.9}increases by {C:money,s:0.8}$#3#{C:inactive}",
                    "{C:inactive,s:0.8}Resets to last paid",
                    "{C:inactive,s:0.8}price at {C:attention,s:0.8}end of round",
                    "{ppu_bubble:usable}"
                },
                flavor = {
                    "Served for oil,",
            ...
            fish_fac_aureallu_cookiecutter_shark = {
                ...
                text = {
                    ...
                    "{C:attention}Lucky{} cards to create a",
                    "{C:attention}D6 Tag{} and be {C:attention}destroyed",
                    "at {C:attention}end of round{}",
                },
                flavor = {
            ...
            fish_fac_aureallu_vampire_squid = {
                ...
                text = {
                    ...
                    "{C:fac_fish}Fish{} is {C:attention}destroyed",
                ...
                text = {
                    {
                        ...
                        "{C:inactive}(Maximum {C:fac_sand_dollars,f:fac_sand_dollars}+$#1#{C:inactive})"
                    },
                    {
                        "{X:fac_sand_dollars,C:white}X#2#{C:money} sell value",
                        "after {C:attention}Boss Blind",
                        "{C:inactive}(Maximum {C:fac_sand_dollars,f:fac_sand_dollars}+$#3#{C:inactive})"
                    }
                },
                flavor = {
                    "Shnark mimimi..",
