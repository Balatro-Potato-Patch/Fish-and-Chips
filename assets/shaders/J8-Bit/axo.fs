...
extern PRECISION vec2 axo;
extern Image extra_texture;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
	...
	if (tex.rgb == vec3(1.0, 0.0, 0.0)){
        ...
        tex.rgb = (0.5+0.5*sin(axo[1]+vec4(13,17,23,1)*Texel(extra_texture, uv * vec2(1.0, -1.0) + 0.5))).rgb;
